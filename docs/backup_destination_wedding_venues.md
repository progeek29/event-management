# Backup: Destination Wedding Venues Block

> **Note**: This block was removed as Shree Ram Events focuses on local luxury celebrations, royal catering, mandap decor, and full wedding management across Chhattisgarh (rather than operating proprietary destination wedding hotel properties).
> Keep this file for future reference in case destination wedding packages or palatial venue tie-ups are launched.

---

### Component Overview
- **Component File**: `src/components/VenuesSection.jsx`
- **Location on Page**: Previously located between `EditorialStorySection` and `CulinarySection` (`<div id="venues">`).

---

### Full Component Code (`VenuesSection.jsx`)
      ...
      <div className="site-container">
        ...
        <div className="section-header-centered">
          ...
          <h2 className="section-title">
            ...
            <span className="font-serif italic font-normal text-[#8C7355]">Destination Wedding Venue</span>
          </h2>
...
### How to Restore in `src/App.jsx`
If ever needed in the future, import and insert `<VenuesSection />` in `src/App.jsx`:

```jsx
import VenuesSection from './components/VenuesSection';

// Inside the JSX flow between moments and culinary:
<div id="venues">
  <VenuesSection
